							...
							<ul>
								...
								@if(Route::has('login'))
									...
									<li class="menu-item menu-item-has-children parent" >
										...
										<li class="menu-item" >
											<a title="Dashboard" href="{{ route('admin.orders') }}">Orders</a>
										</li>
										<li class="menu-item" >
									...
									<li class="menu-item menu-item-has-children parent" >
										...
										<ul class="submenu curency" >
											...
											<li class="menu-item" >
												<a title="Dashboard" href="{{ route('user.categories') }}">Categories</a>
											</li>
											<li class="menu-item" >
												<a title="Dashboard" href="{{ route('user.product') }}">Products</a>
											</li>
											<li class="menu-item" >
												<a title="Dashboard" href="{{ route('user.attributes') }}">Attributes</a>
											</li>
											<li class="menu-item" >
												<a title="Dashboard" href="{{ route('user.homecategories') }}">Home Category</a>
											</li>
											<li class="menu-item" >
												<a title="Dashboard" href="{{ route('user.coupons') }}">All Coupons</a>
											</li>
											<li class="menu-item" >
												<a title="Dashboard" href="{{ route('user.orders') }}">All Orders</a>
											</li>
											<li class="menu-item" >
												<a title="Dashboard" href="{{ route('user.contact') }}">Contact Messages</a>
											</li>
