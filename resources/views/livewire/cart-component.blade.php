        ...
        <div class=" main-content-area">
            ...
            <div class="wrap-iten-in-cart">
                ...
                <ul class="products-cart">
                    @foreach(Cart::instance('cart')->content('cart') as $item)
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-reduce" href="#" wire:click.prevent="discreaseQuantity('{{ $item->rowId }}')"></a>
                            </div>
                    ...
                    @endforeach		
                    @else
                    <h4 style="color:red">No Item in the Cart</h4>
                    @endif										
                </ul>
            </div>
            ...
            <div class="text-center">
                ...
                <p>Add Itme to Cart</p>
                <a href="/shop" class="btn btn-success">Shop Now</a>
            </div>
            @endif
            <div class="wrap-iten-in-cart">
                 <h4 class="title-box" style="border-bottom: 1px solid; padding-bottom:15px; ">{{ Cart::instance('saveForLater')->count() }} item(s) Save For Later</h4>
