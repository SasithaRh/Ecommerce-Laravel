                       ...
                       <div class="billing-address">
                           ...
                           <p class="row-in-form fill-wife">
                            ...
                            <label class="checkbox-field">
                                <input name="different-add" id="different-add" value="forever" wire:model="ship_to_diffrent" type="checkbox">
                ...
                <div class="col-md-12">
                    <div class="wrap-address-billing">
                       ...
                       <div class="billing-address">
                           ...
                           <p class="row-in-form">
                            <label for="zip-code">Province:</label>
                            <input  type="text" name="zip-code" value="" placeholder="Your postal code" wire:model="s_province">
                            @error('s_province')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </p>
